...
import { Platform, Nav,Events, App, ToastController, AlertController, MenuController, ModalController} from 'ionic-angular';
...
export class MyApp {
    ...
    goOnGiftListPage()
    {
        if(this.karigar_detail.status !='Verified'){
            ...
            this.nav.push(RedeemTypePage,{'mode':'home',"balance_point":this.total_balance_point, "redeem_point":this.service.karigar_info.redeem_balance});
        }else{
